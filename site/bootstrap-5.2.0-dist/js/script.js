...
(function (global) {
  ...
  var showLoading = function (selector) {
    ...
    html += "<img src='https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/AjaxLoader.gif'></div>";
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // being passed into the $dk.loadMenuItems function. Think about what that argument needs
...
dk.loadMenuCategories = function () {
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
